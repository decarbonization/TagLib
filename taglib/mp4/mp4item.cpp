...
public:
  ...
  ByteVectorList m_byteVectorList; //Added for artwork support in PlayerKit.
};
...
MP4::Item::Item(ByteVectorList &data) //Added for artwork support in PlayerKit.
{
  d = new ItemPrivate;
  d->m_byteVectorList = data;
}
...
ByteVectorList
MP4::Item::toByteVectorList() const //Added for artwork support in PlayerKit.
{
